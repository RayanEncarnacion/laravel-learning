...
@php
    function getNavClasses($href) {
        return request()->route()->getName() === $href
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <a href="/" class="{{ getNavClasses("/") }} rounded-md px-3 py-2 text-sm font-medium">Home</a>
                <a href="/about" class="{{ getNavClasses("/about") }} rounded-md px-3 py-2 text-sm font-medium">About</a>
                <a href="/contact" class="{{ getNavClasses("/contact") }} rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
